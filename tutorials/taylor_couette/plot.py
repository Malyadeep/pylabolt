...
def analytical(Nx, Ny, r1, r2, omega1, omega2):
    ...
    omega_an = np.zeros(Nx, dtype=np.float64)
...
def main():
    ...
    r1, r2 = 0.2, 0.4
    r_an, omega_an = analytical(201, 201, r1, r2, omega1, omega2)
